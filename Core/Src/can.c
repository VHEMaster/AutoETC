...
#define CAN_LOOPBACK() HAL_GPIO_WritePin(CAN_LBK_GPIO_Port, CAN_LBK_Pin, GPIO_PIN_SET)
#define CAN_NORMAL() HAL_GPIO_WritePin(CAN_LBK_GPIO_Port, CAN_LBK_Pin, GPIO_PIN_RESET)
